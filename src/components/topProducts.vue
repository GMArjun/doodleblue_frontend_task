<template>
  <div class="topProducts">
    <div class="uppercase mb-4 text-sm font-medium text-gray" v-if="generateTopProducts && generateTopProducts.length">Top Products</div>
    <div class="topItems">
      <div class="flex py-4 cursor-pointer" v-for="(product,i) in generateTopProducts" :key="i">
        ...
        <div class="overflow-hidden">
          ...
          <div v-if="product.rating" class="text-xs mb-2 text-yellow">
            <font-awesome-icon v-for="(rating) in product.rating" :key="rating" :icon="['fa', 'star']" class="rating__icon rating__icon--none fa fa-star mr-1"/>
          </div>
